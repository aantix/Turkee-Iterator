...
3) For the samples below, the numbered data points represent the value you should enter for the corresponding field at {https://www.yourapplication.com/turkee_tasks/new}[https://www.yourapplication.com/turkee_tasks/new].
...
==Sample Output
** Here's a few screenshots from a sample run I did using example 2.

    1) {The initial parameters for setting up my Turkee task}[http://imgur.com/13rCM.png]

    2) {Responses I received from the Turkers}[http://imgur.com/ghveH.png]

    3) {The form that was presented to the Turkers (either vote or submit a joke)}[http://imgur.com/229uc.png]
