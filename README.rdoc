...
3) For the samples below, the numbered data points represent the value you should enter for the corresponding form fields at {https://www.yourapplication.com/turkee_tasks/new}[https://www.yourapplication.com/turkee_tasks/new].
